...
// imperatywne opisuje w jaki sposob jest coś robione, pętle for itp (to powyzej)
// deklaratywne skupia się co chcemy zrobić, metody np reduce mowi co jest do zrobienia. (poniżej)
